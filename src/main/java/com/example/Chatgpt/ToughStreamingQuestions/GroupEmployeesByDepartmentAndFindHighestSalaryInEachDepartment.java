...
public class GroupEmployeesByDepartmentAndFindHighestSalaryInEachDepartment {
    public static void main(String[] args) {
        ...
        System.out.println(list.stream().collect(Collectors.groupingBy(Employee::getDepartment))
                ...
                .entrySet()
                .stream()
                .collect(Collectors.toMap(Map.Entry::getKey,e->e.getValue().stream().max(Comparator.comparing(Employee::getSalary))))
